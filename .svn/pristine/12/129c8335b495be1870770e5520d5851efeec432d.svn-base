...
public class SessionListener implements HttpSessionListener {  
    ...
    public void sessionCreated(HttpSessionEvent se) {  
    	System.out.println(se.getSession().getId()+":"+se.getSession());
    	System.out.println("创建session"+new Date().getTime()+hUserName.get("user"));
    }  
   ...
   */
    public void sessionDestroyed(HttpSessionEvent se) {  
    	System.out.println("销毁session"+new Date().getTime());
