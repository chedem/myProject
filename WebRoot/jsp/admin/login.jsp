				...
				<div class="logo_box">
					...
					<form action="login3.do" name="f" method="post">
						...
						<div class="input_outer">
							<span class="u_user"></span> <input id="user" name="logname"
								class="text" style="color: #FFFFFF !important" type="text"
								placeholder="请输入账户" tabindex="1" size="15">
						</div>
						<div class="input_outer">
							<span class="us_uer"></span> <input id="pass" name="logpass"
								class="text"
								style="color: #FFFFFF !important; position:absolute; z-index:100;"
								value="" type="password" placeholder="请输入密码">
						</div>
						<div class="mb2">
							<input type="submit" class="dlsubmit" style="color: #FFFFFF"
								value="登录">
						</div>
