...
<body>
	<div class="wrapper wrapper-content animated fadeInRight">
		<div class="ibox float-e-margins">
			<div class="example-wrap">
				<h4 class="example-title">部门管理</h4>
				<div class="example">
					<div class="row">
						<div class="col-xs-8">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input id="sectionCode" name="sectionCode"
														class="form-control" type="text" placeholder="请输入部门编码"
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input id="sectionName" name="sectionName"
														...
														aria-invalid="true" class="error" placeholder="请输入部门名称"
														required aria-required="true">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input id="institution" name="institution"
														class="form-control" type="text" aria-required="true"
														aria-invalid="false" class="valid" placeholder="请输入所属机构"
														required aria-required="true">
												</div>
											</div>
											<div class="form-group">
	...
	<script>
		$(function() {
			$.getJSON("../js/data/section.json",function(data){
