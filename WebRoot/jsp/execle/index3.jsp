  ...
  <body>
  	...
  	<div class="bodys">
	  	...
	  	<span>时间：</span><input type="text" id="startDate" readonly="readonly"><span>到</span><input type="text" id="endDate">
	  	   <input type="button" id ="dl" class='btn btn-info' onclick="wzExecle4()" style="color: #FFFFFF"; value="查看">
	  	</div>
     <div class="daochu_zhanshi">
     	<div class="daochu">
<%--      	     	  <a href="jsp/execle/userFile/<%=session.getAttribute("userName")==null?"":session.getAttribute("userName")%>3.xls" download="利润表.xls">物装表</a>
 --%>     	  <a href="jsp/execle/userFile/3.xls" download="物装报表.xls">一键导出物装报表</a>
   		</div>
