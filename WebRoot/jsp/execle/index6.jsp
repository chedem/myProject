  ...
  <body>
  	...
  	<div class="bodys">
	  	...
	  	<span>时间：</span><input type="text" id="startDate1" ><span>到</span><input type="text" id="endDate">
	  	   <input type="button" id ="dl" class='btn btn-info' onclick="wzcfExecle()" style="color: #FFFFFF"; value="查看">
	  	</div>
     <div class="daochu_zhanshi">
     	<div class="daochu">
     	  <a href="jsp/execle/userFile/6.xls" download="应收账款余额表.xls">一键导出应收账款余额表</a>
   		</div>
